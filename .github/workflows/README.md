...
| --------------------------------- | ------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `build-windows.yml`               | `Build Windows Desktop App`    | Builds the Windows desktop installer (.exe) and portable zip with Electron Forge on every commit and uploads downloadable artifacts. | `push` to any branch/tag; `pull_request` on `opened/synchronize/reopened`; or `workflow_dispatch`.                   | None.                                                                                                                                                                                               |
| `build-desktop-matrix.yml`        | `Multi-Platform Desktop Matrix`| Builds Windows (x64), macOS (universal/x64), and Linux (deb/x64) desktop packages on main branch pushes or manual dispatch.          | `push` to `main` and `v*` tags; or `workflow_dispatch`.                                                             | None.                                                                                                                                                                                               |
